...
class LLMAgent(BaseAgent):
    ...
    def get_system_prompt_for_workflow(self):
        ...
        - Your responsibilities:
            - Every few steps the VLA performs, you will receive a high-level instruction, visual observations, the groundtruth workflow of the task, current step(how many steps VLA has performed), and current subtask.
        ...
        Plan: <Your plan as a numbered list of subtasks, each subtask should be a simple and specific action>
            ...
            ...
            < there is a \n after this sentence>
            < the subtask should be from the workflow>
    ...
    def generate_plan_from_llm(self, obs, is_workflow):
    ...
    def get_action(self, obs, description, step, use_which_external_camera, is_workflow, base_dirs=None):
        ...
        if step % self.observation_frequency == 0:
            result = self.generate_plan_from_llm(obs, is_workflow)
            if not result:
