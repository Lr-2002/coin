...
class OpenCabinetWithObstacleEnv(UniversalTabletopEnv):
    """
    **Task Description:**
    ...
    **Success Conditions:**
    ...
    workflow = ["push the box", "open the cabinet door"]
    ...
    def _initialize_episode(self, env_idx, options=None):
        ...
        self.block.set_pose(sapien.Pose(p=[-0.15, -0.28, 0]))
    ...
    def _get_success(self, env_idx=None):
        ...
        if self.get_articulation_joint_info(self.cabinet, self.target_joint_name) > 0.4:
