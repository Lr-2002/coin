...
class CloseDrawerWithObstacleEnv(UniversalTabletopEnv):
    """
    **Task Description:**
    ...
    **Success Conditions:**
    ...
    def __init__(
        ...
        **kwargs,
        ...
        self.tags = {
            ...
            "rob": [Robot.ACT_NAV, Robot.PERSPECTIVE],
        ...
        self.query_query = "What should do first before closing the drawer?"
        self.query_selection = {"A": "Open the cabinet", "B": "Move the stick away"}
        self.query_answer = "B"
    ...
    def _load_scene(self, options=None):
        ...
        self.box1 = actors.build_box(
            self.scene, [0.03, 0.16, 0.02], np.array([1, 0, 0, 1]), "box"
        )
    ...
    def _load_cabinet(self, cabinet_id):
        ...
        if self.cabinet_config_path:
            ...
            return load_articulation_from_json(
                ...
                json_type="urdf",
                position_override=[-0.15, -0.5, 0.35],
        ...
        position = np.array([-0.15, -0.55, table_height + offset])
    ...
    def _initialize_episode(self, env_idx, options=None):
        ...
        self.box1.set_pose(
            sapien.Pose(p=[-0.15, -0.55, 0.6], q=euler2quat(*np.deg2rad([20, 0, 0])))
        )
    ...
    def _get_success(self, env_idx=None):
        ...
        if self.get_articulation_joint_info(self.cabinet, "joint_1") <= 0.05:
