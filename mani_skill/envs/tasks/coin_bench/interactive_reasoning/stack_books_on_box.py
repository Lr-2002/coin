...
@register_env("Tabletop-Stack-Books-OnBox-v1", max_episode_steps=5000)
class StackBooksOnBoxEnv(UniversalTabletopEnv):
    """
    **Task Description:**
    ...
    **Success Conditions:**
    ...
    def __init__(
        ...
        **kwargs,
        ...
        self.query_answer = "B"
        # Did it pick up the green book?
        # Did it put one of the book on the top of another?
    ...
    def _get_success(self, env_idx=None):
        ...
        book_height_check = min([bbx.pose.p[0][2] for bbx in self.books]) > 0.1
        # Set success if both conditions are met
        if books_stacked and robot_static and book_height_check:
