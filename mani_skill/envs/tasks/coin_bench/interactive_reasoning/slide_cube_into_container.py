...
@register_env("Tabletop-Slide-Cube-Into-Container-v1", max_episode_steps=5000)
class SlideCubeIntoContainerEnv(UniversalTabletopEnv):
    """
    **Task Description:**
    ...
    **Success Conditions:**
    ...
    description = "Slide a cube down a slope into a container"
    workflow = ["move the cube target at the dustpan", "push the cube down the slope"]
    ...
    def __init__(
        ...
        **kwargs,
        ...
        self.query_query = "How can we put the cube to the container?"
        ...
        # Did it push the cube to the dustpan?
    ...
    def _initialize_episode(self, env_idx: torch.Tensor, options: dict):
        ...
        if self.container is not None:
            container_pos_x = 0.32  # In front of the slope
            container_pos_y = 0.0
    ...
    def _get_success(self, env_idx=None):
        ...
        if cube_in_container and robot_static:
