...
@register_env("Tabletop-Close-Door-WithObstacle-v1", max_episode_steps=5000)
class CloseDoorWithObstacleEnv(UniversalTabletopEnv):
    """
    **Task Description:**
    ...
    **Success Conditions:**
    ...
    workflow = ["open the door", "move the bowl", "close the door"]
    ...
    def __init__(
        ...
        **kwargs,
        ...
        self.query_query = "What should be done first to close the door?"
    ...
    def _load_scene(self, options=None):
        ...
        # )
        self.bowl = self.load_from_config("configs/bowl.json", name="bowl")
    ...
    def _initialize_episode(self, env_idx, options=None):
        ...
        self.bowl.set_pose(sapien.Pose(p=[0.15, 0.06, 0.01], q=[0.707, 0.707, 0, 0]))
    ...
    def _get_success(self, env_idx=None):
        ...
        if self.get_articulation_joint_info(self.door, "joint_1") <= 0.1:
