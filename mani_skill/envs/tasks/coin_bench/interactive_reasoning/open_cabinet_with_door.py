...
class OpenCabinetWithDoorEnv(UniversalTabletopEnv):
    """
    **Task Description:**
    ...
    **Success Conditions:**
    ...
    workflow = ["close the door", "open the cabinet door"]
    ...
    def __init__(
        ...
        **kwargs,
        ...
        self.query_query = "What's the correct sequence of actions to open the cabinet?"
    ...
    def _initialize_episode(self, env_idx, options=None):
        ...
        self.set_articulation_joint(self.door, "joint_1", 0.8, easy_pd=(1, 0.1))
    ...
    def _get_success(self, env_idx=None):
        ...
        if self.get_articulation_joint_info(self.door, "joint_1") < 0.4:
            self.set_articulation_joint(self.door, "joint_1", 0)

        if self.get_articulation_joint_info(self.cabinet, "joint_0") > 0.9:
