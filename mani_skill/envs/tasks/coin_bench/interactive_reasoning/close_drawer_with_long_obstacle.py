...
class CloseDrawerWithLongObstacleEnv(UniversalTabletopEnv):
    """
    **Task Description:**
    ...
    **Success Conditions:**
    ...
    def __init__(
        ...
        **kwargs,
        ...
        self.query_query = "What's the best approach to close the drawer?"
    ...
    def _load_cabinet(self, cabinet_id):
        ...
        position = np.array([-0.15, -0.5, table_height + offset])
    ...
    def _initialize_episode(self, env_idx, options=None):
        ...
        self.box1.set_pose(
            sapien.Pose(p=[-0.15, -0.2, 0.62], q=euler2quat(*np.deg2rad([10, 0, 0])))
        )
