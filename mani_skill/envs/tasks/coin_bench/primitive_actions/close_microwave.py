...
@register_env(
    "Tabletop-Close-Microwave-v1",
    max_episode_steps=5000,
)
class CloseMicrowaveEnv(UniversalTabletopEnv):
    """
    **Task Description:**
    ...
    **Success Conditions:**
    ...
    def _load_microwave(self, microwave_id):
        ...
        position = np.array([0.0, -0.38, table_height])
    ...
    def _initialize_episode(self, env_idx, options=None):
        ...
        self.set_articulation_joint(self.microwave, "joint_0", 0.8)
    ...
    def _get_success(self, env_idx=None):
        ...
        if self.get_articulation_joint_info(self.microwave, "joint_0") <= 0.1:
