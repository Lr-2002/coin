...
@register_env("Tabletop-Rotate-Cube-v1", max_episode_steps=5000)
class RotateCubeEnv(UniversalTabletopEnv):
    """
    ...
    description = "rotate the cube till the white face upward"
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.initial_position = [0.05, 0.0, 0.02]
    ...
    def _load_scene(self, options: dict):
        ...
        self.cube = self.load_from_config(
            "configs/rubik_cube.json", "rubik", body_type="dynamic", convex=True
        )
